...
Models.TaskTypeDetail = require('./index');
...
Models.TaskTypeDetail.belongsTo(Models.Task, {foreignKey: 'taskID'});
Models.TaskTypeDetail.belongsTo(Models.Detail, {foreignKey: 'detailID'});
Models.Detail.hasMany(Models.TaskTypeDetail, {foreignKey: 'detailID'});
...
Models.Detail.sync();
Models.TaskTypeDetail.sync();

Models.TaskTypeDetail.deleteTaskTypeDetail = (array) => {
    return new Promise((resolve, reject) => {
        Models.TaskTypeDetail
            .destroy({
                where: {
                    id: array
                }
...
Models.TaskTypeDetail.createTaskTypeDetail = (taskID, array) => {
    return new Promise((resolve, reject) => {
        array.forEach(item => {
            item.taskID = taskID
        });
...
Models.TaskTypeDetail.getTaskTypeDetail = (taskID) => {
    return new Promise((resolve, reject) => {
        Models.TaskTypeDetail
            .findAll({
                where: {
...
Models.TaskTypeDetail.updateDetailType = function (array) {
    return new Promise((resolve, reject) => {
...
Models.TaskTypeDetail.updateDetailTypeStatus = function (taskID) {
    return new Promise((resolve, reject) => {
