    ...
    m.defaults =
        {
            ...
            oLanguage: {
                ...
                oPaginate: {sFirst: "Первая", sLast: "Последняя", sNext: "Дальше", sPrevious: "Назад"},
                sEmptyTable: "Нет данных",
                sInfo: "Отображается с _START_ до _END_ из _TOTAL_ записей",
                sInfoEmpty: "Отображается c 0 до 0 с 0 записей",
                sInfoFiltered: "",
                sInfoPostFix: "",
                sDecimal: "",
                sThousands: ",",
                sLengthMenu: "Показать _MENU_ записей на одной странице",
